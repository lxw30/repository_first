...
extern void ADC2_Task_Func(void *argument);
extern void PWM_Task_Func(void *argument);
...
void MX_FREERTOS_Init(void) {
  ...
  ADC2_TaskHandle = osThreadNew(ADC2_Task_Func, NULL, &ADC2_Task_attributes);

  /* creation of PWM_Task */
  PWM_TaskHandle = osThreadNew(PWM_Task_Func, NULL, &PWM_Task_attributes);
